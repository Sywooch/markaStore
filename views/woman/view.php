...
/* @var $model app\models\Woman */
    ...
    $this->params['breadcrumbs'][] = ['label' => $model->genus->genus, 'url' => ['index?type=' . $model->type_id]];
    ...
    <tr>
        ...
        <div class="row">
            ...
            <?php foreach (Images::find()->select('img_file')->where(['product_id' => $model->product_id])->andWhere(['color_id' => $color])->all() as $img): ?>
                ...
                <img style="padding-bottom: 5px; padding-top: 5px;" height="500px" src="<?php echo '/images/' . Html::encode($img->img_file) ?>"
            ...
            all() as $img): ?>
                    ...
                    list($width, $height) = getimagesize($imgs); ?>
            <div class="col-md-<?php echo $width > $height ? '9' : '6'; ?>">
                <img style="padding-bottom: 5px; padding-top: 5px;" height="500px" src="<?echo '/images/' . Html::encode($img->img_file) ?>"
                     alt="<?php echo $model->name->name . '-' . $model->brand->brand; ?>">
            </div>
                <?php endforeach; ?>
            <?php endif ?>
...
<td width="40%">
        <p> <h4 class="text-uppercase"><?= Html::encode($model->name->name); ?> <?= Html::encode($model->brand->brand); ?> </br><small>арт. <?=
